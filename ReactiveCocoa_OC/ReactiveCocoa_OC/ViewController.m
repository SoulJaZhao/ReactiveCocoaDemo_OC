...
- (IBAction)btnClick:(id)sender {
    ...
    [twoVC.delegateSignal subscribeNext:^(id x) {
        [twoVC dismissViewControllerAnimated:YES completion:nil];
        NSLog(@"点击了通知按钮");
    }];
